...
X-ray [[Pulsars]] are accreting from a donor. For very strong mangetic fields $B\sim 10^8\,\pu{T}$ accreted material is directed along field lines to magnetic poles, resulting in magnetic dipole radiation (but for lower magnetic fields the star is spun up, as in a [[#53|millisecond pulsar]]). The pulses are the resulting beams of radiation (Mason: NOT JETS, a jet is ionized material) emitted at the magnetospheric radius (see [[#64]]) crossing our line of sight as the pulsar rotates.
